...
#		puts sitepackages36
		...
		if Dir.exist?(HOMEBREW_PREFIX/"lib/python3.4/site-packages")
			sitepackages34.install_symlink "lib/sitecustomize.txt"
		end

		if Dir.exist?(HOMEBREW_PREFIX/"lib/python3.6/site-packages")
			sitepackages36.install_symlink "lib/sitecustomize.txt"
		end

		if Dir.exist?(HOMEBREW_PREFIX/"lib/python3.7/site-packages")
			sitepackages37.install_symlink "lib/sitecustomize.txt"
		end
#		lib.install Dir["*"]
	end
  end
